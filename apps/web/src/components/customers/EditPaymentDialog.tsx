// apps/web/src/components/customers/EditPaymentDialog.tsx
...
export function EditPaymentDialog({ payment, invoices, open, onOpenChange }: EditPaymentDialogProps) {
  ...
  const content = <>
    <DialogHeader className="shrink-0 border-b border-slate-200 px-4 py-4 sm:px-6 sm:py-5"><DialogTitle>编辑回款</DialogTitle><DialogDescription>可更正金额、到账状态、日期、备注与关联发票。</DialogDescription></DialogHeader>
