    ...
    <Dialog onOpenChange={onOpenChange} open={open}>
      <DialogContent>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1.5"><Label htmlFor="user-wechat-id">企业微信 UserID</Label><Input id="user-wechat-id" onChange={(event) => setWechatUserId(event.target.value)} placeholder="选填，用于后续绑定企微扫码登录及接收续费提醒" value={wechatUserId} /></div>
        </div>
