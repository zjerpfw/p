...
export function DealDetailModal({ deal, onOpenChange }: DealDetailModalProps) {
  ...
  const expireDate = useMemo(() => {
    ...
    return Number.isNaN(parsed.getTime()) ? '' : dateInput(addMonths(addYears(parsed, durationYears), giftMonths).toISOString())
