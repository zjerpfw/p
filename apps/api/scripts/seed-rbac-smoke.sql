...
-- Test login password: 123456. The value persisted in D1 is a PBKDF2 hash.
INSERT INTO users (id, name, role, pin_hash) VALUES
  ('smoke_admin', '测试管理员', 'admin', 'pbkdf2-sha256$210000$X17gsnxmEtwbYMQEBzzw4g$uxu26XbjJsvXOeLKO34XErdryCo20i6xeao1SyOQJ2I'),
  ('smoke_sales_a', '销售A', 'sales', 'pbkdf2-sha256$210000$X17gsnxmEtwbYMQEBzzw4g$uxu26XbjJsvXOeLKO34XErdryCo20i6xeao1SyOQJ2I'),
  ('smoke_sales_b', '销售B', 'sales', 'pbkdf2-sha256$210000$X17gsnxmEtwbYMQEBzzw4g$uxu26XbjJsvXOeLKO34XErdryCo20i6xeao1SyOQJ2I');
...
INSERT INTO deals (id, customer_id, amount_cents, stage, expected_close_date, created_at, net_profit_cents) VALUES
